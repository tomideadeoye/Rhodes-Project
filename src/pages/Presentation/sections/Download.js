        ...
        <Container sx={{ position: "relative", zIndex: 2, py: 12 }}>
          <Grid container item xs={12} md={7} justifyContent="center" mx="auto" textAlign="center">
            ...
            <MKTypography variant="body2" color="white" mb={6}>
              ...
              makes you stand out each time is a compelling brand message that prospects can
              identify with, a huge part of why storytelling matters. <br />
              There is no stronger connection between humans than storytelling. People want to
              interact with brands that see them, understand their needs and reflect their values –
              No better way to compel action and drive behavior than infusing storytelling into your
